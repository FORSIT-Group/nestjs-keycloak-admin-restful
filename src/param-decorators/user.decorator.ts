...
export const User = createParamDecorator((_data: unknown, ctx: ExecutionContext): KeycloakUser => {
 ...
 * @fritzforsit
 */
export const UserGroups = createParamDecorator((groupName: string, ctx: ExecutionContext) => {
  try {
 ...
 * @fritzforsit
 */
export const UserScopes = createParamDecorator((data: any, ctx: ExecutionContext) => {
  try {
    const request = ctx.switchToHttp().getRequest()
 ...
 * @fritzforsit
 */
export const UserRoles = createParamDecorator((data: any, ctx: ExecutionContext) => {
  try {
    const request = ctx.switchToHttp().getRequest()
